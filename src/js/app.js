...
//           <div class="bg-white rounded-lg overflow-hidden shadow-md w-full h-full">
...
//                 </div>
//                 <h4 class="font-medium text-gray-800 text-base sm:text-lg">Temple Finder App</h4>
//               </div>
//               <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
//                 <button class="py-2 rounded flex flex-col items-center justify-center bg-blue-50 text-blue-600 text-xs sm:text-sm">
//                   <i class="fas fa-place-of-worship mb-1"></i>
//                   <span>Temples</span>
//                 </button>
//                 <button class="py-2 rounded flex flex-col items-center justify-center bg-gray-100 text-gray-600 text-xs sm:text-sm">
...
//                 <p class="text-sm text-gray-700 text-center sm:text-left">Select a temple to view 360° panorama</p>
//               </div>
//             </div>
//           </div>
//         </div>
